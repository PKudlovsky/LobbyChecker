    ...
    internal class Program
    {
        ...
        private static void Refresh()
        {
            while (true)
            {
                ...
                {
                    Console.Clear();
                    AnsiConsole.Write(new Markup("[u][Green]https://github.com/PKudlovsky/LobbyChecker[/][/]")
                        .Centered());
                    AnsiConsole.Write(new Markup("[u][red][b]In case of any problem contact me on Kudlo#7777[/][/][/]").Centered());
                    Console.WriteLine();
                    Console.WriteLine();
